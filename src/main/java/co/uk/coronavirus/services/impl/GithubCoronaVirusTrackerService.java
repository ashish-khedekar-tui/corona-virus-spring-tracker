...
@Service (value = "githubCoronaVirusTrackerService")
public class GithubCoronaVirusTrackerService implements CoronaVirusTrackerService
{

   final static Logger LOG = LoggerFactory.getLogger(GithubCoronaVirusTrackerService.class);
